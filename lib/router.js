...
if( Meteor.isClient){
  ...
  */
  ...
  /*
    Route: Edit Posts
    TODO: Combine "Edit Posts" route and "Posts" route together so that switching between edit-page and page is seamless. (Currently there is a millisecond stutter that should be avoided.)
  */
